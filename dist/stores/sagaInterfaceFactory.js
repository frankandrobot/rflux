...
exports.default = sagaInterfaceFactory;
...
function sagaInterfaceFactory(_ref) {
  var AppDispatcher = _ref.AppDispatcher,
      appStateObservable = _ref.appStateObservable;


  var sideEffects = (0, _kefirEmitter2.default)();
  ...
  function put(action) {
    ...
    setTimeout(function () {
      return AppDispatcher.emit(action);
    }, 0);
  ...
  function listen(channel, actionType) {
    ...
    return AppDispatcher.filter(function (action) {
...
//# sourceMappingURL=sagaInterfaceFactory.js.map
